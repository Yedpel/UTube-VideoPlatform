...
public class Video {
    ...
    public Video(String title, String author, int views, String uploadTime, String thumbnailUrl, String authorProfilePicUrl, String videoUrl, String category, int likes) {
        this.title = title;
        this.author = author;
        this.views = views;
