...
//    public void editVideo(String videoId, String title, String category, File videoFile, String userId, String token) {
//        videoApi.editVideo(videoId, title, category, Uri.fromFile(videoFile), userId, token);
//    }
