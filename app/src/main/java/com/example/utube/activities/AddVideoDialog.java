...
public class AddVideoDialog extends DialogFragment {
    ...
    private AddVideoViewModel viewModel; //try-ch-mvvm
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(AddVideoViewModel.class); //try-ch-mvvm
        ...
        viewModel.getCategories().observe(this, categories -> { //try-ch-mvvm
        ...
        viewModel.getSelectedImageUri().observe(this, uri -> { //try-ch-mvvm
            if (uri != null) {
        ...
        addVideoButton.setOnClickListener(v -> {
            ...
            if (viewModel.isInputValid(title, category)) { //try-ch-mvvm
...
//        super.onActivityResult(requestCode, resultCode, data);
//        if (requestCode == REQUEST_IMAGE_PICK && resultCode == getActivity().RESULT_OK && data != null) {
//            viewModel.setSelectedImageUri(data.getData()); //try-ch-mvvm
//
//        }
//    }
}
